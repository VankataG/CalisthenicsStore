        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(2050)", maxLength: 2050, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("26a82284-2ce9-40b1-a92a-1ed2f744f2b5"), "Rings" },
                    { new Guid("435dd8b6-28b5-48e9-b3b5-5bea8c19a4e4"), "Books & Training Guides" },
                    { new Guid("529d56fc-1398-4cb3-8890-1e56209f951f"), "Wrist & Lifting Wraps" },
                    { new Guid("5a5e8602-4521-4a8a-b0c6-9b1180a6bafc"), "Bars" },
                    { new Guid("7722f1a4-07c5-4385-a868-4592c2235928"), "Resistance Bands" },
                    { new Guid("95fa052b-0876-4e21-b1c6-669de1fddcea"), "Training Apparel" },
                    { new Guid("a74a64ea-32ab-48b0-a915-a363ca3c6dbd"), "Floor Mats" },
                    { new Guid("c82d3fda-b115-4c76-91da-7f7bc722eb1c"), "Grip Trainers" },
                    { new Guid("e8e47bf6-78e7-4fee-b9d5-d21cb551e0c8"), "Parallettes" },
                    { new Guid("fe94fada-1ab8-4892-83a3-216639c03579"), "Weighted Vests" }
                });
